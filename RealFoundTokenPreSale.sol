...
import "./RealFoundToken.sol";

contract RealFoundTokenPreSale {
    RealFoundToken public token;
    ...
    function RealFoundTokenPreSale(
        RealFoundToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = RealFoundToken(_token);
